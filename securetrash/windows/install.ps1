...
# `securetrash` on PATH to a .ps1 BEFORE a .cmd of the same name, and a .ps1 is refused
...
$ScriptPath = Join-Path $LibDir 'securetrash.ps1'
...
$shim = @"
@echo off
pwsh -NoProfile -ExecutionPolicy Bypass -File "%~dp0lib\securetrash.ps1" %*
...
$legacyScript = Join-Path $InstallDir 'securetrash.ps1'
