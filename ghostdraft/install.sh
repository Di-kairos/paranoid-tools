...
#   curl -fsSLO https://github.com/Di-kairos/paranoid-tools/releases/download/ghostdraft-v0.1.19/install.sh
#   curl -fsSLO https://github.com/Di-kairos/paranoid-tools/releases/download/ghostdraft-v0.1.19/SHA256SUMS
