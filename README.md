...
> [threat model](https://github.com/Di-kairos/paranoid-tools/blob/main/THREAT-MODEL.md). Pin a specific version with `SEEDSPLIT_VERSION=0.5.0` instead of `latest` for
