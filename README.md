...
> [threat model](https://github.com/Di-kairos/paranoid-tools/blob/main/THREAT-MODEL.md). Pin a specific version with `SEEDSPLIT_VERSION=0.4.1` instead of `latest` for
