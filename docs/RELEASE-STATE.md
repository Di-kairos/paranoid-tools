...
> **Дрейф на 2026-08-05 (s29): закрыт.** У каждого тула после тега остаётся только
> `chore(formula)` — формула пере-синкается под уже выпущенный релиз, это норма, не дрейф.
