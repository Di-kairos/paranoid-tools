...
> versa), and `split`/`combine` have been run by hand in a Windows 11 console. What is *not*
> yet broadly field-tested: exotic console code pages and locales. Verify on a throwaway
> secret before trusting a real seed phrase.
